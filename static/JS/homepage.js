...
window.onload = function() {
          fetch('../washingpoints')
              ...
              .then(function(myJson) {
                var wm = myJson.result[0].washing_machines;
                  console.log(wm);
            ...
            for(let i=0; i<nr_washing_machines; i++) {
                ...
                //     });
                        ...
                        // for(int j = 0; j < i; j++){
                        //   if(wm[i].occupied.length != 0) {
                        //     for(int k = 0; k < wm[i].occupied.length; k++) {
                        //       wm[i].occupied[k].start_time.
                        //       input_hour[] .setAttribute("class", "occupied");
                        //     }
                        //   }
                        // }
